...
requires_gfx950 = skipUnless(
    _is_gfx950(), "Gluon flex-attention is only offered on AMD gfx950"
)
...
class TestGluonFlexAttention(InductorTestCase):
    ...
    def _check(
        self, *, dtype, head_dim, mask_fn=None, score_mod=None, seq_len=None, force=True
    ):
