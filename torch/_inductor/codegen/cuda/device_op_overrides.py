    ...
    def tma_descriptor_helpers(self) -> str:
        ...
        return """
            ...
            [[maybe_unused]] static void initTMADescriptorWithMetadata(
                ...
                // Descriptor initialization runs before every launch, while the
                // CUDA driver version is process-wide.
                static int driverVersion = -1;
                static std::once_flag driverVersionInitFlag;
                std::call_once(driverVersionInitFlag, []() {
                    CUDA_DRIVER_CHECK(cuDriverGetVersion(&driverVersion));
                });
